...
class DeleteCompanyUseCaseTest {
    ...
    void deleteCompany_multipleCompanies_deletesOnlySpecified() {
        ...
        createUseCase.createCompany(inputData1, (company, context, created) -> {
            contextGateway.save(context);
        });
        ...
        createUseCase.createCompany(inputData2, (company, context, created) -> {
            contextGateway.save(context);
        });
    ...
    void deleteCompany_nullParentContext_throwsResourceNotFoundException() {
        ...
        Context companyContext = new Context(companyId, COMPANY_CONTEXT_TYPE_ID, null, COUNTRY_ID, "Orphan Company", "999999999");
    ...
    void deleteCompany_contextNotFound_throwsResourceNotFoundException() {
        UUID customerId = UUID.randomUUID();
        UUID companyId = UUID.randomUUID();
        Context companyContext = new Context(companyId, COMPANY_CONTEXT_TYPE_ID, customerId, COUNTRY_ID, "Company Without Context", "777777777");
